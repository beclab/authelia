...
func NewFileAuthorizer(config *schema.Configuration) Authorizer {
...
func (p *FileAuthorizer) IsSecondFactorEnabled() bool {
	return p.mfa
}
...
func (p *FileAuthorizer) GetRuleMatchResults(subject Subject, object Object) (results []RuleMatchResult) {
	skipped := false
