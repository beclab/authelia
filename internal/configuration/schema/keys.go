...
var Keys = []string{
	...
	"authentication_backend.lldap.implementation",
	"authentication_backend.lldap.url",
	"authentication_backend.lldap.timeout",
	"authentication_backend.lldap.start_tls",
	"authentication_backend.lldap.tls.minimum_version",
	"authentication_backend.lldap.tls.maximum_version",
	"authentication_backend.lldap.tls.skip_verify",
	"authentication_backend.lldap.tls.server_name",
	"authentication_backend.lldap.tls.private_key",
	"authentication_backend.lldap.tls.certificate_chain",
	"authentication_backend.lldap.base_dn",
	"authentication_backend.lldap.additional_users_dn",
	"authentication_backend.lldap.users_filter",
	"authentication_backend.lldap.additional_groups_dn",
	"authentication_backend.lldap.groups_filter",
	"authentication_backend.lldap.group_name_attribute",
	"authentication_backend.lldap.username_attribute",
	"authentication_backend.lldap.mail_attribute",
	"authentication_backend.lldap.display_name_attribute",
	"authentication_backend.lldap.permit_referrals",
	"authentication_backend.lldap.permit_unauthenticated_bind",
	"authentication_backend.lldap.permit_feature_detection_failure",
	"authentication_backend.lldap.user",
	"authentication_backend.lldap.password",
	"authentication_backend.lldap.server",
	"authentication_backend.lldap.port",
